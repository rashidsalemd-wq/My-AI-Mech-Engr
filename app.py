...
st.markdown("#### مساعد المهندس الشخصي: خبير تقني متخصص في أنظمة التكييف (HVAC)، مكافحة الحريق (Firefighting)، كاميرات المراقبة (CCTV)، وشبكات الصرف الصحي (Plumbing) وفق معايير SEC و NFPA.")
st.divider()
